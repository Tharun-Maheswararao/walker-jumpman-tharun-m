...
| **Game-source revision shown in the film** | `b3b4d19` — *Paint a launch guide at the Terrace take-off window; reposition road labels* |
...
```bash
git diff --stat b3b4d19 <submitted-sha> -- godot/
```
