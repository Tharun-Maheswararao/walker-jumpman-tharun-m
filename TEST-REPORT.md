...
**Source revision under test:** `5bdd71e` (see the revision table at the bottom).
...
**7.2 Results — executed 2026-09-24, revision `5bdd71e`, by me (Tharun).**
...
| `67eebe3` | Playtest: R relabelled, prediction D refuted |
| `5bdd71e` | Overshoot-impossibility assertion — **the final game-source revision, and the one this report describes** |
